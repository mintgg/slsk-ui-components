...
import { X, Eye, EyeOff, Loader2, ChevronDown, Search } from 'lucide-react';
...
var InputBase = React5.forwardRef(
  (_a, ref) => {
    var _b = _a, {
      value,
      defaultValue,
    ...
    const [innerValue, setInnerValue] = React5.useState(defaultValue != null ? defaultValue : "");
    ...
    const emitChange = React5.useCallback(
      (nextValue, event) => {
        if (!isControlled) {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "relative flex items-center", children: [
      ...
      suffixCount > 0 ? /* @__PURE__ */ jsxs("div", { className: "absolute right-2 flex items-center gap-1", children: [
...
var Password = React5.forwardRef(
  (_a, ref) => {
    ...
    const [innerVisible, setInnerVisible] = React5.useState(
    ...
    const visibilityButton = showVisibilityToggle ? /* @__PURE__ */ jsx(
      "button",
      {
        type: "button",
...
var TextArea = React5.forwardRef(
  (_a, ref) => {
    ...
    const resizeTextarea = React5.useCallback(() => {
...
function InputExample() {
  const [value, setValue] = React5.useState("\u53EF\u7F16\u8F91\u7684\u53D7\u63A7\u503C");
  const [enterValue, setEnterValue] = React5.useState("-");
  const { Password: Password2, TextArea: TextArea2 } = Input;
  return /* @__PURE__ */ jsxs("div", { className: "grid gap-4 p-4", children: [
    /* @__PURE__ */ jsx(Input, { value, onChangeValue: setValue, placeholder: "\u8BF7\u8F93\u5165\u5185\u5BB9" }),
    /* @__PURE__ */ jsx(Input, { defaultValue: "\u9ED8\u8BA4\u503C", placeholder: "\u975E\u53D7\u63A7\u8F93\u5165" }),
    /* @__PURE__ */ jsx(
      Input,
      {
    ...
    /* @__PURE__ */ jsx(Input, { status: "error", placeholder: "\u9519\u8BEF\u72B6\u6001" }),
    /* @__PURE__ */ jsx(Input, { status: "warning", placeholder: "\u8B66\u544A\u72B6\u6001" }),
    /* @__PURE__ */ jsx(Input, { disabled: true, defaultValue: "\u7981\u7528\u72B6\u6001" }),
    /* @__PURE__ */ jsx(Input.Password, { placeholder: "\u8BF7\u8F93\u5165\u5BC6\u7801" }),
    /* @__PURE__ */ jsx(Password2, { placeholder: "\u89E3\u6784\u4F7F\u7528 Password" }),
    /* @__PURE__ */ jsx(Input.TextArea, { placeholder: "\u8BF7\u8F93\u5165\u591A\u884C\u5185\u5BB9", rows: 3 }),
    /* @__PURE__ */ jsx(
      TextArea2,
      {
...
var Select = React5.forwardRef(
  ({
    ...
    var _a, _b;
    const isControlled = value !== void 0;
    const [innerValue, setInnerValue] = React5.useState(defaultValue);
    ...
    return /* @__PURE__ */ jsxs("div", { ref: containerRef, className: "relative", children: [
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("span", { className: "flex min-w-0 items-center gap-2 truncate text-left", children: [
              (selectedOption == null ? void 0 : selectedOption.icon) ? /* @__PURE__ */ jsx("span", { "aria-hidden": "true", className: "text-base leading-none", children: selectedOption.icon }) : null,
              /* @__PURE__ */ jsx("span", { className: "truncate", children: (_b = (_a = selectedOption == null ? void 0 : selectedOption.label) != null ? _a : placeholder) != null ? _b : "\u8BF7\u9009\u62E9" })
            ] }),
            /* @__PURE__ */ jsxs("span", { className: "ml-3 flex shrink-0 items-center gap-1 text-muted-foreground", children: [
              ...
              /* @__PURE__ */ jsx(ChevronDown, { className: cn("h-4 w-4 transition-transform", open && "rotate-180") })
            ] })
          ]
        }
      ),
      open ? /* @__PURE__ */ jsx("div", { className: "absolute z-20 mt-2 w-full rounded-md border bg-white p-1 shadow-md", children: options.length > 0 ? /* @__PURE__ */ jsx("div", { role: "listbox", className: "grid gap-1", children: options.map((option) => {
        ...
        return /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              option.icon ? /* @__PURE__ */ jsx("span", { "aria-hidden": "true", className: "text-base leading-none", children: option.icon }) : null,
              /* @__PURE__ */ jsx("span", { className: "truncate", children: option.label })
            ]
          },
          String(option.value)
        );
      }) }) : /* @__PURE__ */ jsx("div", { className: "px-3 py-2 text-sm text-muted-foreground", children: "\u6682\u65E0\u53EF\u9009\u9879" }) }) : null
    ] });
  }
);
...
function SelectExample() {
  const [value, setValue] = React5.useState("shanghai");
  return /* @__PURE__ */ jsxs("div", { className: "grid gap-4 p-4", children: [
    /* @__PURE__ */ jsx(
      Select,
      {
    ...
    /* @__PURE__ */ jsx(Select, { defaultValue: "m", options: sizeOptions, placeholder: "\u975E\u53D7\u63A7\u9ED8\u8BA4\u503C" }),
    /* @__PURE__ */ jsx(Select, { loading: true, options: cityOptions, placeholder: "\u52A0\u8F7D\u4E2D\u72B6\u6001" }),
    /* @__PURE__ */ jsx(Select, { status: "error", options: cityOptions, placeholder: "\u9519\u8BEF\u72B6\u6001" }),
    /* @__PURE__ */ jsx(Select, { status: "warning", options: cityOptions, placeholder: "\u8B66\u544A\u72B6\u6001" }),
    /* @__PURE__ */ jsx(Select, { disabled: true, options: cityOptions, placeholder: "\u7981\u7528\u72B6\u6001" }),
    /* @__PURE__ */ jsx(Select, { hideClear: true, options: cityOptions, placeholder: "\u9690\u85CF\u6E05\u7A7A\u6309\u94AE" }),
...
export { Input, InputExample, Password, Select, SelectExample, TextArea };
